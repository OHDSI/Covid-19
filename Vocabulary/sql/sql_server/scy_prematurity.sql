...
AND (CONCEPT_CODE LIKE '644%'
     OR CONCEPT_CODE LIKE '765%'
	 OR CONCEPT_CODE LIKE '776.6%'
	 OR CONCEPT_CODE IN ('362.2','362.20','362.21','362.22','362.23','362.24','362.25','362.26','362.27')
	 )
AND CONCEPT_CODE != '765.29'
) AS con_rel
