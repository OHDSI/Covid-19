...
AND (CONCEPT_CODE LIKE '250%'
	 OR CONCEPT_CODE LIKE '251%'
	 OR CONCEPT_CODE LIKE '648.0%'
	 OR CONCEPT_CODE LIKE '357.2%'
	 OR CONCEPT_CODE LIKE '362.0%'
	 OR CONCEPT_CODE LIKE '362.11%'
	 OR CONCEPT_CODE LIKE '366.41%'
	 )
) AS con_rel
