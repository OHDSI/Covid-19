--HIV/AIDS
--Since 043, 044 do not exist in ICD-9 CM anymore, we need to find other codes for HIV / AIDS
...
AND (CONCEPT_CODE LIKE '042%'
	 OR CONCEPT_CODE LIKE '043%'
	 OR CONCEPT_CODE LIKE '044%'
	 OR CONCEPT_CODE LIKE 'V08%'
	 )
) AS con_rel
