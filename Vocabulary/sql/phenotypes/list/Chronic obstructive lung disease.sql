...
WHERE phenotype = 'Chronic obstructive lung disease'
;
...
SELECT 'Chronic obstructive lung disease', 'inclusion', c.*
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Chronic obstructive lung disease',
       'not_mapped',
       c.*
FROM @vocabulary_database_schema.concept c
...
WHERE (
        ...
        (c.concept_name ~* 'Chronic obstructive lung disease|COPD|Chronic obstructive lung disease|chronic obstructive airway disease|COAD|pulmonary emphysema'

        --Masks to exclude
        AND c.concept_name !~* 'vaccine|excluded|spirometry|immunization|Corticoadrenal'
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Chronic obstructive lung disease', 'exclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
