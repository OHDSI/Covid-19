...
WHERE phenotype = 'Peritoneal dialysis'
;
...
SELECT 'Peritoneal dialysis', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
37397621,	--	718308002	Observation	Peritoneal dialysis care	SNOMED
4324124	--	71192002	Procedure	Peritoneal dialysis	SNOMED
