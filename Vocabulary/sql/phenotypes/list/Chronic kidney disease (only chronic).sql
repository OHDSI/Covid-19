...
WHERE phenotype = 'Chronic kidney disease (only chronic)'
;
...
SELECT 'Chronic kidney disease (only chronic)', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
4128228,	--	236519008	Condition	Chronic drug-induced renal disease	SNOMED
46271022,	--	709044004	Condition	Chronic kidney disease	SNOMED
40478891,	--	444271000	Condition	Erythropoietin resistance in anemia of chronic kidney disease	SNOMED
44782728	--	15781000119107	Condition	Hypertensive heart AND chronic kidney disease with congestive heart failure	SNOMED
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Chronic kidney disease (only chronic)',
       'not_mapped',
       c.*
FROM @vocabulary_database_schema.concept c
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Chronic kidney disease (only chronic)', 'exclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
