...
WHERE phenotype = 'Ventricular Septal Defects'
;
...
SELECT 'Ventricular Septal Defects', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
35625532 	--	768552007	Condition	Congenital ventricular septal defect	SNOMED
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Ventricular Septal Defects',
       'not_mapped',
       c.*
FROM @vocabulary_database_schema.concept c
...
WHERE (
        ...
        (c.concept_name ~* 'VSD|(Ventr).*(sept).*(def)|(def).*(ventr).*(sept)'

        --Masks to exclude
        AND c.concept_name !~* 'Atrioventricular'
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Ventricular Septal Defects', 'exclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
40489971,	--	448475002	Condition	Absent pulmonary valve syndrome with ventricular septal defect of non Fallot type	SNOMED
4103131,	--	253514004	Condition	Dextraposition of aorta in Fallot's tetralogy	SNOMED
37109597,	--	723336008	Condition	Fallot complex with intellectual disability and growth delay syndrome	SNOMED
4070297,	--	204306007	Condition	Pentalogy of Fallot	SNOMED
40486625,	--	447838003	Condition	Pulmonary atresia and ventricular septal defect with aorta from left ventricle	SNOMED
40486626,	--	447839006	Condition	Pulmonary atresia and ventricular septal defect with aorta from right ventricle	SNOMED
4109337,	--	253591008	Condition	Pulmonary atresia with ventricular septal defect	SNOMED
35624311,	--	766976003	Condition	Pulmonary valve agenesis, tetralogy of Fallot, absence of ductus arteriosus syndrome	SNOMED
320835,	--	86299006	Condition	Tetralogy of Fallot	SNOMED
4163292,	--	399228007	Condition	Tetralogy of Fallot with absent pulmonary valve	SNOMED
4101619,	--	253513005	Condition	Tetralogy of Fallot with pulmonary atresia	SNOMED
42538671,	--	762433009	Condition	Tetralogy of Fallot with pulmonary atresia and systemic-to-pulmonary collateral artery	SNOMED
4101618,	--	253512000	Condition	Tetralogy of Fallot with pulmonary stenosis	SNOMED
4101620 	--	253515003	Condition	Ventricular septal defect in Fallot's tetralogy	SNOMED
