...
WHERE phenotype = 'Multiple organ failure'
;
...
SELECT 'Multiple organ failure', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
4212484,	--	57653000	Condition	Multiple organ failure	SNOMED
506600,	--	1052121000000102	Measurement	qSOFA - quick Sequential Organ Failure Assessment	SNOMED
37394662,	--	1036761000000109	Measurement	Sepsis-related Organ Failure Assessment	SNOMED
36684937,	--	459231000124102	Measurement	Sequential organ failure assessment score	SNOMED
506601,	--	1052131000000100	Observation	quick Sepsis-related Organ Failure Assessment score	SNOMED
37394663	--	1036771000000102	Observation	Sepsis-related Organ Failure Assessment score	SNOMED
...
WHERE (
        ...
        (c.concept_name ~* '(Multiple).*(organ)|SOFA|Sequential Organ Failure'

        --Masks to exclude
        AND c.concept_name !~* 'Injur|Kaposi|rheumatoid|exposure to|drug resistant|Infectious|Sofa surfer'
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Multiple organ failure', 'exclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
