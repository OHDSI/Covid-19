...
WHERE phenotype = 'Atrial Septal Defects'
;
...
SELECT 'Atrial Septal Defects', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
4236884,	--	405752007	Condition	Congenital atrial septal defect	SNOMED
434467,	--	204315000	Condition	Ostium secundum type atrial septal defect	SNOMED
4316879 	--	95268002	Condition	Sinus venosus atrial septal defect	SNOMED
...
WHERE (
        ...
        (c.concept_name ~* 'ASD|(Atr).*(sept).*(def)|(def).*(atr).*(sept)'
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Atrial Septal Defects', 'exclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
4066746,	--	17394001	Condition	Ebstein's anomaly with atrial septal defect	SNOMED
4070916,	--	204351007	Condition	Fallot's trilogy	SNOMED
