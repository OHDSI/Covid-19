...
WHERE phenotype = 'Tetralogy of Fallot'
;
...
SELECT 'Tetralogy of Fallot', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
40487550,	--	448007000	Condition	Atrioventricular septal defect associated with tetralogy of Fallot	SNOMED
40488437,	--	448155003	Condition	Pulmonary atresia with ventricular septal defect of Fallot type	SNOMED
...
WHERE (
        ...
        (c.concept_name ~* 'Tetralogy|Fallo'

        --Masks to exclude
        AND c.concept_name !~* 'fallopian'
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Tetralogy of Fallot', 'exclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
