...
SELECT 'Lymphopenia', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
441541,	--	48813009	Condition	Lymphocytopenia	SNOMED
37062698,	--	LP392998-3	Measurement	Lymphocytes/100 leukocytes | Blood | Hematology and Cell counts	LOINC
37060904,	--	LP392919-9	Measurement	Lymphocytes | Blood | Hematology and Cell counts	LOINC
4254663,	--	74765001	Measurement	Lymphocyte count	SNOMED
37393858	--	1022581000000105	Observation	Lymphocyte count	SNOMED
...
WHERE (
        ...
        (c.concept_name ~* 'Lymphocytopenia|Lymphopenia|(low).*(lymph)|(lymph).*(count)'

        --Masks to exclude
        AND c.concept_name !~* ('lymphoma|neoplasm|in body fluid|in pleural|in unspecified|in synovial|in cerebral|in bone|in bronchial|in pericardial|in peritoneal|' ||
            'in Vitreous fluid|in Dialysis fluid')
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Lymphopenia', 'exclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
35622306 	--	763713000	Condition	Idiopathic CD4 lymphocytopenia	SNOMED
