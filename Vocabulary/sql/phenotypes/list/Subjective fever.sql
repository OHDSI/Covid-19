...
WHERE (
        ...
        (c.concept_name ~* '(subjective|feel).*(fever)|(fever).*(subjective|feel)|feverish|(subjective|feel).*(fever)|(fever).*(subjective|feel)|(high).*(temp)|(temp).*(high)|(subjective|feel).*(pyrexia)|(pyrexia).*(subjective|feel)'
