...
WHERE phenotype = 'Patent Ductus Arteriosus'
;
...
SELECT 'Patent Ductus Arteriosus', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
43021335,	--	460613004	Condition	Ductus arteriosus dependent systemic circulation	SNOMED
315922,	--	83330001	Condition	Patent ductus arteriosus	SNOMED
36716262,	--	722211006	Condition	Patent ductus arteriosus, bicuspid aortic valve, hand anomaly syndrome	SNOMED
37206979 	--	787779000	Observation	Persistent truncus arteriosus	SNOMED
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Patent Ductus Arteriosus',
       'not_mapped',
       c.*
FROM @vocabulary_database_schema.concept c
...
WHERE (
        ...
        (c.concept_name ~* 'PDA|ductus arteriosus|arteriosus'
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Patent Ductus Arteriosus', 'exclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
37204212 	--	782724001	Condition	Multisystemic smooth muscle dysfunction syndrome	SNOMED
