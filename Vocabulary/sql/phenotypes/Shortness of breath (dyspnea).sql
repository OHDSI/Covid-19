...
WHERE phenotype = 'Shortness of breath (dyspnea)'
;
...
SELECT 'Shortness of breath (dyspnea)', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
312437	--	267036007	Condition	Dyspnea	SNOMED
...
INSERT INTO @target_database_schema.concept_phenotypes
SELECT 'Shortness of breath (dyspnea)',
       'not_mapped',
       c.*
FROM @vocabulary_database_schema.concept c
...
WHERE (
        ...
        (c.concept_name ~* 'Shortness of breath|dyspnea|breath Shortness'
