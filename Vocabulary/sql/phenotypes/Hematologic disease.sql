...
WHERE phenotype = 'Hematologic disease'
;
...
SELECT 'Hematologic disease', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
443723,	--	414022008	Condition	Disorder of cellular component of blood	SNOMED
4185470,	--	414026006	Condition	Disorder of hematopoietic morphology	SNOMED
317248,	--	414027002	Condition	Disorder of hematopoietic structure	SNOMED
4179872	--	362970003	Condition	Disorder of hemostatic system	SNOMED
    )
;
...
WHERE (
        ...
        (c.concept_name ~* 'hemopoetic|haemopoetic|hemostatic|(blood).*(disease)|(disease).*(blood)|(blood).*(disorder)|(disorder).*(blood)'

        --Masks to exclude
         AND c.concept_name !~* 'family|fh|screen|assessment|vessel|normal|monitoring|phenx|poisoning|gas|function'
