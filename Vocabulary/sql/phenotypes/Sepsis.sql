...
SELECT 'Sepsis', 'inclusion', c.*
FROM devv5.concept c
WHERE c.concept_id IN (
--Put concept_ids here
37395517,	--	1048491000000106	Condition	Acute kidney injury due to acute tubular necrosis due to sepsis	SNOMED
36716312,	--	722278006	Condition	Acute kidney injury due to sepsis	SNOMED
40487101,	--	447931005	Condition	Clinical sepsis	SNOMED
4293282,	--	402958005	Condition	Gonococcal bacteremia-induced pustular vasculitis	SNOMED
4199233,	--	434156008	Condition	Infectious agent in bloodstream	SNOMED
4205449,	--	55528005	Condition	Menosepsis	SNOMED
4085627,	--	18613002	Condition	Miscarriage with septic shock	SNOMED
4204036,	--	308887002	Condition	Postprocedural intra-abdominal sepsis	SNOMED
4066124,	--	200195002	Condition	Puerperal septicemia - delivered with postnatal complication	SNOMED
132797,	--	91302008	Condition	Sepsis	SNOMED
4046106,	--	230361008	Condition	Sepsis-associated encephalopathy	SNOMED
4119941,	--	233812001	Condition	Sepsis-associated lung injury	SNOMED
4031168,	--	238151006	Condition	Sepsis-associated organ dysfunction	SNOMED
4029281,	--	238150007	Condition	Sepsis syndrome	SNOMED
196236,	    --	76571007	Condition	Septic shock	SNOMED
36716754	--	722926003	Condition	Transient neonatal neutropenia due to neonatal bacterial sepsis	SNOMED
...
WHERE (
        ...
        (c.concept_name ~* 'Sepsis|Bacter(a)?emia|Septic(a)?emia|(septic).*(shock)'

        --Masks to exclude
        AND c.concept_name !~* 'Suspected'
...
INSERT INTO dev_covid19.concept_phenotypes
SELECT 'Sepsis', 'exclusion', c.*
FROM devv5.concept c
WHERE c.concept_id IN (
--Put concept_ids here
46285743	--	975661000000100	Observation	Sepsis care	SNOMED
    )
;
