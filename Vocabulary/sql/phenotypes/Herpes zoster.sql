...
SELECT 'Herpes zoster', 'inclusion', c.*
FROM @vocabulary_database_schema.concept c
WHERE c.concept_id IN (
--Put concept_ids here
4326661,	--	428633000	Condition	Exanthem due to herpes zoster	SNOMED
256036,	--	31920006	Condition	Hemorrhagic varicella pneumonitis	SNOMED
45770836,	--	98541000119101	Condition	Herpes zoster myelitis	SNOMED
45757253,	--	1087131000119102	Condition	Herpes zoster scleritis	SNOMED
4101894,	--	193190005	Condition	Polyneuropathy in herpes zoster	SNOMED
44790710,	--	239981000000102	Condition	Shingles exanthem	SNOMED
4206579 	--	309465005	Condition	Varicella-zoster virus infection	SNOMED
...
WHERE (
        ...
        (c.concept_name ~* 'zoster|varicella|shingles'

        --Masks to exclude
        AND c.concept_name !~* 'vaccination|allergy|postvaricella'
